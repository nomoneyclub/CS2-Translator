...
### Fixed
- **Multi-Monitor Support** - Auto-region now correctly detects primary monitor
- **Translation Errors** - Improved error handling with automatic translator recreation
- **Region Detection** - Better screen capture coordinates for multi-monitor setups

### Changed
- Auto-region now uses mss library for accurate monitor detection
- Increased chat region size for better text capture (30% width, 15% height)
